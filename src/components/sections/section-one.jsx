    ...
    return (
        <section className="w-full h-calcvh flex justify-center items-center font-mont">
            ...
            <div className="w-1/3 max-md:w-1/2 flex flex-col gap-4 text-center items-center z-10">
                <span className="text-neutral-200 text-5xl">Unlocking the Power of AI: Buy and trade cryptos Pioneering Web3 Innovation.</span>
                ...
                <div className="flex gap-4">
                    <button className="button-gradient border-[1px] border-[#6C00FF] py-2 px-2 rounded-xl text-white transition duration-200 font-mont text-lg">Buy presale Mumulana</button>
